...
function parseSCSS (filename) {
  return exporter({
    inputFiles: [
      'node_modules/govuk-frontend/govuk/settings/' + filename,
      'node_modules/@hmlr/frontend/src/hmlr/settings/' + filename
    ],
    includePaths: [
      'node_modules/govuk-frontend/govuk/settings/',
      'node_modules/@hmlr/frontend/src/hmlr/settings/'
    ]
  }).getStructured()
}
